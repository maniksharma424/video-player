  ...
  return (
    <div className="flex justify-start sm:w-1/3 pl-10">
      <div
        ...
        className=" flex justify-between items-center    w-1/2 border h-7 hover:text-black p-1 px-2 rounded-md border-gray-200 shadow-sm font-[300] text-[14px] cursor-pointer text-gray-500 "
      >
